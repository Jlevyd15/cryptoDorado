...
import { auth, isAuthenticated, writeUserData, removeUserData, isUserLoggedIn } from '../../firebase';
...
class Dashboard extends Component {
  ...
  handleRemoveData() {
    console.log('in write data')
    if (isUserLoggedIn) {
      removeUserData("/walletData/-KpBquX6VGU0zk2gQmwC")
    }
  }
          ...
          <div className="col-sm-6 col-lg-3">
            <div className="card card-inverse card-primary">
              <div className="card-block pb-0">
                ...
                <h4 className="mb-0">{this.state.firebase}</h4>
                <p>Members online</p>
              </div>
